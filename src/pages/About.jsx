...
function AboutUs() {
  return (
    <section className="py-16 px-6 GradientNeon   ">
      {/* Container Wrapper */}
      <div className="container my-16 mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="shadow-md shadow-purple-500 p-6 rounded-lg  border-purple-800 border-2  hover:scale-105">
            <h3 className="text-3xl font-bold text-slate-200">500+</h3>
            <p className="text-gray-400">Local Shops Regsitered</p>
          </div>
          <div className="shadow-md shadow-purple-500 p-6 rounded-lg  border-purple-800 border-2  hover:scale-105">
          ...
          <div className="shadow-md shadow-purple-500 p-6 rounded-lg  border-purple-800 border-2  hover:scale-105">
            <h3 className="text-3xl font-bold text-slate-200">50K+</h3>
        ...
        <div className="mb-12">
          <h3 className="text-2xl font-bold mb-6 text-slate-100 ">What is Localify?</h3>
