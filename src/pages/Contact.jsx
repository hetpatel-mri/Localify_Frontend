...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen GradientNeon flex justify-center items-center ">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl p-8 mx-auto">
        {/* Contact Information Section */}
        <div
          className=" bg-gradient-to-tr from-purple-950 to-fuchsia-950 border-2  rounded-lg p-8 text-white flex flex-col justify-between"
        ...
        <div className="bg-purple-900/40 border-2 text-slate-300 shadow-lg rounded-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="mt-1 p-2 text-slate-900 block w-full bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                  required
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="mt-1 p-2 block w-full bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 text-slate-900"
                />
              </div>
            </div>

            <div>
              <label className="block text-gray-200">Select Subject</label>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="4"
                className="mt-1 text-slate-900 p-2 block w-full bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
                required
              ></textarea>
            </div>
