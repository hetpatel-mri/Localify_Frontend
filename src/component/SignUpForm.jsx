...
const SignupForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-purple-900 to-black  flex items-center flex-col justify-center bg-gray-100 w-full">
      <p
      ...
      <ToastContainer />
      <div className="bg-black/60 p-6  rounded-lg shadow-lg w-[700px]">
          ...
          <div className="grid grid-cols-2 items-center justify-center gap-2">
            <div>
              ...
              <input
                ...
                className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-300 bg-transparent border-2 border-purple-700leading-tight focus:outline-none focus:shadow-outline"
            ...
            <div className="relative">
              ...
              <div>
                ...
                <button
                  ...
                  className="text-blue-500 text-sm mx-2 absolute top-[40px] right-2"
                >
                  {showPassword ? (
                    <IoMdEyeOff className="text-slate-200 text-xl" />
                  ) : (
                    <IoMdEye className="text-slate-200 text-xl" />
                  )}
                </button>
              </div>
            </div>
