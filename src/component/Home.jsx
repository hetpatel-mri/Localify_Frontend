...
function Home() {
  return (
    <div className="w-full GradientNeon relative flex flex-col items-center ">
      {/* Hero Section */}
      <div className="  w-full p-3   h-[60vh] md:h-screen bgImage flex justify-center items-center flex-col ">
        <div className="mx-10 my-3 shadow-md shadow-black  bg-black/50 p-8 rounded-sm  flex flex-col justify-center items-center gap-5">
        <h1 className="text-[8vh] drop-shadow-lg text-bold   text-center ">
          Welcome To <span className="fancyFont text-amber-500 ">
            
            Localify
            </span>

        </h1>
        <p className="text-center text-2xl mt-6">Connecting World</p>
        </div>
        {/* <motion.div className="flex bg-black opacity-80 rounded-2xl flex-col justify-between items-center p-5 " initial="initial" animate="animation">
          ...
          <motion.p className="text-slate-600 mainimageanimaion font-semibold text-white/80 text-xl my-2">Where you can </motion.p>
